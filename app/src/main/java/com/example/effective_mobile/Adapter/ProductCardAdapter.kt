...
class ProductCardAdapter(val listener: Listener, val listener2: Listener2) :
    ListAdapter<ItemsProductModel, ProductCardAdapter.Holder>(Comparator()) {
